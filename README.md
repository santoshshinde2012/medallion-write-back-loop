...
Companion code for the series article **Medallion Has a Write-Back Problem**
(*Agents now write to your lakehouse, and nothing in Bronze, Silver, or Gold says where those writes belong. Four kinds, four homes.*) ([draft & research](https://github.com/santoshshinde2012/blogs/tree/main/articles/017-medallion-write-path);
